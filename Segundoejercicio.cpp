        ...
        switch (opcion) {
            case 1: {
                do {
                    ...
                    printf("? Nacional (9 dígitos) o Extranjera (12 dígitos): ");
                    scanf("%s", cedula);
                    ...
                    if (longitud != 9 && longitud != 12) {
                        printf("? Cédula inválida. Debe tener 9 (nacional) o 12 (extranjera) dígitos.\n");
                    } else {
                        break;
                    }
                } while (1);
                ...
                if (tipoTiquete != 1 && tipoTiquete != 2) {
                    printf("Tipo de tiquete inválido.\n");
                    break;
                }

                printf("Ingrese la cantidad de tiquetes (máximo %d): ", maximoTiquetes);
                scanf("%d", &cantidad);
                ...
                printf("Cédula: %s\n", cedula);
                printf("Nombre: %s\n", nombre);
                printf("Tipo de cliente: %s\n", (tipoCliente == 1) ? "Niño o Adulto Mayor" : "Adulto");
